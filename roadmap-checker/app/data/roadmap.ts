...
export const INITIAL_ROADMAP: RoadmapItem[] = [
    ...
    // DevOps
    {
        id: 'docker',
        title: 'Docker',
        description: 'コンテナ技術の基礎。アプリケーションを環境に依存せずパッケージ化し、デプロイを容易にします。',
        requiredOutput: false,
        dependencies: ['nodejs'],
        category: 'DevOps',
        tutorials: [
            { title: 'Docker Documentation', url: 'https://docs.docker.com/' },
            { title: 'Docker 入門', url: 'https://docs.docker.jp/get-started/index.html' },
        ],
        children: [
            {
                id: 'docker-basics',
                title: 'Docker Basics',
                description: 'イメージとコンテナの概念。docker run, build, psなどの基本コマンド。',
                requiredOutput: false,
                dependencies: [],
                category: 'DevOps',
            },
            {
                id: 'dockerfile',
                title: 'Dockerfile',
                description: 'Dockerfileの作成。FROM, COPY, RUN, CMD命令を使用したイメージのビルド。',
                requiredOutput: false,
            ...
            },
            {
                ...
                description: '複数コンテナの管理。docker-compose.ymlでのサービス定義とネットワーク設定。',
                requiredOutput: false,
    ...
    },
    {
        ...
        description: '継続的インテグレーション/デプロイメント。自動テスト、ビルド、デプロイのパイプラインを構築します。',
        requiredOutput: false,
        dependencies: ['git', 'jest', 'docker'],
        category: 'DevOps',
        tutorials: [
            { title: 'GitHub Actions Documentation', url: 'https://docs.github.com/ja/actions' },
        ],
        children: [
            {
                id: 'github-actions-basics',
                title: 'Workflow Basics',
                description: 'ワークフローファイルの作成。on, jobs, stepsの基本構造。',
                requiredOutput: false,
                dependencies: [],
                category: 'DevOps',
            },
            {
                ...
                description: 'プッシュやプルリクエスト時の自動テスト実行。テスト結果のレポート。',
                requiredOutput: false,
                dependencies: ['github-actions-basics'],
                category: 'DevOps',
            },
            {
                id: 'deployment-pipeline',
                title: 'Deployment Pipeline',
                description: '本番環境への自動デプロイ。環境変数とシークレットの管理。',
                requiredOutput: false,
    ...
    },
    {
        id: 'vercel',
        title: 'Vercel',
        description: 'Next.jsアプリケーションのホスティングプラットフォーム。簡単なデプロイと環境管理を学びます。',
        requiredOutput: true,
        ...
        children: [
            {
                ...
                title: 'Deployment',
                description: 'GitHubリポジトリとの連携。自動デプロイの設定。',
                requiredOutput: false,
                dependencies: [],
                category: 'DevOps',
            },
            {
                ...
                description: '環境変数の設定と管理。本番環境とプレビュー環境の使い分け。',
                requiredOutput: false,
            ...
            },
            {
                ...
                description: 'カスタムドメインの設定。DNS設定とSSL証明書の自動発行。',
                requiredOutput: false,
